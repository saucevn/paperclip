          ...
          <div className="-mt-8 px-4 pb-4">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1 pt-1">
                ...
                {version ? (
                  <p className="mt-1 text-xs text-muted-foreground">{t("sidebar.account.version", { version })}</p>
                ) : null}
              </div>
            </div>
            ...
            <div className="mt-4 space-y-1">
              <MenuAction
                label={t("sidebar.account.viewProfile")}
                description={t("sidebar.account.viewProfileDescription")}
                icon={UserRound}
                href={profileHref}
              ...
              <MenuAction
                ...
                description={t("sidebar.account.editProfileDescription")}
                icon={UserRoundPen}
              ...
              <MenuAction
                ...
                description={t("sidebar.account.instanceSettingsDescription")}
                icon={Settings}
              ...
              <MenuAction
                ...
                description={t("sidebar.account.documentationDescription")}
                icon={BookOpen}
                href={DOCS_URL}
                external
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    <span className="block text-xs text-muted-foreground">
                      {t("sidebar.account.signOutDescription")}
                    </span>
                  </span>
                </button>
              ) : null}
