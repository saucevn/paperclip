...
export function CompanySettings() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      ...
      { label: tNav("breadcrumbs.settings") }
    ]);
  }, [setBreadcrumbs, selectedCompany?.name, tNav]);
    ...
    <div className="max-w-2xl space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  {logoUrl && (
                    <div className="flex items-center gap-2">
                      ...
                      >
                        {clearLogoMutation.isPending ? t("company.removingLogo") : t("company.removeLogo")}
                      </Button>
                    </div>
                  )}
      ...
      {generalDirty && (
        <div className="flex items-center gap-2">
          ...
          >
            {generalMutation.isPending ? t("company.saving") : t("company.save")}
          </Button>
      ...
      <div className="space-y-4" data-testid="company-settings-invites-section">
        <div className="text-xs font-medium text-muted-foreground uppercase tracking-wide">
          {t("company.sectionInvites")}
        </div>
        <div className="space-y-3 rounded-md border border-border px-4 py-4">
          <div className="flex items-center gap-1.5">
            <span className="text-xs text-muted-foreground">
              {t("company.generateOpenClaw")}
            </span>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            >
              {inviteMutation.isPending
                ? "Generating..."
                : t("company.generateOpenClawButton")}
            </Button>
          </div>
          {inviteError && (
      ...
      <div className="space-y-4">
        <div className="text-xs font-medium text-muted-foreground uppercase tracking-wide">
          {t("company.sectionCompanyPackages")}
        </div>
        <div className="rounded-md border border-border px-4 py-4">
          <p className="text-sm text-muted-foreground">
            {t("company.companyPackagesNote")}
          </p>
